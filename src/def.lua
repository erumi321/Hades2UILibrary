...
--	function public.Components.do_stuff(a, b) end
...
---@param env table The environment of the plugin to own the objects this will create
...
function public.Components.RadioButton.Create(env, screen, args) end

---@param env table The environment of the plugin to own the objects this will create
---@param RadioButtonObject table Any radio button returned by Create
---@return nil
function public.Components.RadioButton.Destroy(RadioButtonObject) end
...
function public.Components.Dropdown.Create(env, screen, args) end

---@param DropdownObject table The dropdown object to add the option to
---@param option string The value of the option to add
---@return nil
function public.Components.Dropdown.AddOption(DropdownObject, option) end
...
---@return nil
function public.Components.Dropdown.RemoveOption(DropdownObject, option) end

---@param DropdownObject table The Dropdown to destroy
---@return nil
function public.Components.Dropdown.Destroy(DropdownObject) end
...
function public.Components.RadialMenu.Create(env, screen, args) end


---@param RadialMenuObject table The RadialMenu to expand
---@return nil
function public.Components.RadialMenu.Expand(RadialMenuObject) end

---@param RadialMenuObject table The RadialMenu to collapse
---@return nil
function public.Components.RadialMenu.Collapse(RadialMenuObject) end

---@param RadialMenuObject table The RadialMenu to destroy
---@return nil
function public.Components.RadialMenu.Destroy(RadialMenuObject) end
